...
ig.Box2DEntity = ig.Entity.extend({
	...
	triggerNewBlock: function() {
		...
		var blockHeight = position.y / b2.SCALE - this.size.y / 2;
		var screenHeight = 4020;
		var currentHeight = ig.game.height;
		if(screenHeight - blockHeight > currentHeight) {
				ig.game.height = Math.round(screenHeight - blockHeight);
		}
		ig.game.newBlock();
	}
});
